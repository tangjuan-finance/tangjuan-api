...
#     def test_create_scenario_expense_service(self, default_account):
...
#         payload = create_scenario_expense_payload(scenario_id, expense_id)

#         # Act: Call the service to create the expense
#         expense_domain = ScenarioExpenseService.create_scenario_expense(
...
#     def test_update_scenario_expense_service(self, default_account):
